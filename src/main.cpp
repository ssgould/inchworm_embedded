	...
	if(testState == TEST_ALL || testState == TEST_ENCODERS || testState == TEST_MOTORS){
		...
		*/
		...
		if(USE_MOTORS){
			...
			jointMotor[0] = JointMotor2(JOINT_MOTOR0_FWD, JOINT_MOTOR0_REV, JOINT_MOTOR0_EN, // A-LINK WRIST
										JOINT_MOTOR0_ADR, 10, 0, 0, 10, 0, 0, 0.0, -180, 180, false, 0);
			jointMotor[1] = JointMotor2(JOINT_MOTOR1_FWD, JOINT_MOTOR1_REV, JOINT_MOTOR1_EN, // AB-LINK JOINT
										JOINT_MOTOR1_ADR, 10, 0, 0, 10, 0, 0, 0.0, -10, 90, false, 1);
			jointMotor[2] = JointMotor2(JOINT_MOTOR2_FWD, JOINT_MOTOR2_REV, JOINT_MOTOR2_EN, // BC-LINK JOINT
										JOINT_MOTOR2_ADR, 22, 0.5, 0, 23, 0.4, 0, 0.0, -10, 140, true, 2);
			jointMotor[3] = JointMotor2(JOINT_MOTOR3_FWD, JOINT_MOTOR3_REV, JOINT_MOTOR3_EN, // CD-LINK JOINT
										JOINT_MOTOR3_ADR, 8, .3, 0, 23, .4, 0, 0.0, -10, 90, true, 3);
			jointMotor[4] = JointMotor2(JOINT_MOTOR4_FWD, JOINT_MOTOR4_REV, JOINT_MOTOR4_EN, // D-LINK WRIST
										JOINT_MOTOR4_ADR, 10, 0, 0, 10, 0, 0, 0.0, -180.0, 180.0, false, 4);
